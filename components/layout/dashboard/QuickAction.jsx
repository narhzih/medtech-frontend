...
function QuickAction() {
  return (
    <div className="border rounded-2xl shadow-sm bg-white p-6 flex flex-col gap-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-6">
        <Action
          icon={<CirclePlus size={22} className="text-blue-600" />}
        ...
        <Action
          icon={<Pen size={22} className="text-blue-600" />}
